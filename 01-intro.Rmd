...
La siguiente tabla muestra las observaciones de la variable dependiente y con
sus correspondientes valores estimados y residuales para este modelo:
...
Como ilustración vamos a usar los datos del ejemplo 14.3 del libro de @canavos1987probabilidad. En el cual los autores ajustan un modelo de regresión lineal múltiple para predecir el costo unitario de fabricación de uno de sus productos como una función de la tasa de producción y de los costos de material y mano de obra.

El objetivo es obtener:

-   IC del 95% para $E(Y|x_{0})$ cuando $x_{0}=13 $

-   IC del 95% para $E(Y|x_{0})$ cuando $x_{0}=13$

-   IC del 90% para $E(Y|x_{0})$ cuando $x_{0}=3$

-   Cree el diagrama de dispersión agregando las líneas de los IC de 95% para $E(Y|x_{0})$ y $\hat{Y}_{0}$
