...
\end{equation}
$$ donde $\varepsilon_{i}=y_{i}-\beta_{0}-\sum_{i=1}^{k}\beta_{j}x_{ij}$
...
$$ Después de simplificar las ecuaciones anteriores, se obtienen las ecuaciones normlaes de mínimos cuadrados ordinarios.
...
$$
$$\boldsymbol{=(X'X)^{-1}X'(X\beta+\varepsilon)-\beta}$$ 
$$\boldsymbol{=(X'X)^{-1}X'X\beta + (X'X)^{-1}X'                   \varepsilon-\beta}$$ $$\boldsymbol{=I\beta+(X'X)^{-1}X'\varepsilon-\beta}$$ $$=\boldsymbol{(X'X)^{-1}X'\varepsilon}$$ Por lo tanto:
...
$$Var(\hat{\beta_{0}})=\sigma^{2}C_{00}=$$ $$Var(\hat{\beta_{1}})=\sigma^{2}C_{11}=$$ $$Var(\hat{\beta_{2}})=\sigma^{2}C_{22}=$$ $$Cov(\hat{\beta_{0}},\hat{\beta_{1}})=\sigma^{2}C_{01}=$$ $$Cov(\hat{\beta_{0}},\hat{\beta_{2}})=\sigma^{2}C_{02}=$$ $$Cov(\hat{\beta_{1}},\hat{\beta_{2}})=\sigma^{2}C_{12}=$$ La estimación de $\sigma^{2}$ $$
\boldsymbol{Y'Y}=
$$ $$
